...
async def denoise_audio(
    ...
    try:
        ...
        # Use FileResponse and pass the cleanup task to its background parameter.
        # This ensures the file is deleted only after it has been sent.
        return FileResponse(
            path=output_path,
        ...
        # This cleanup runs regardless of whether the request succeeds or fails,
        # ensuring the original uploaded file is always removed.
